...
def combined_potential(obstacles_grid, goal, influence_radius=1, attractive_coef=1./700, repulsive_coef=300, nrows=500, ncols=500):
    """ Repulsive potential """
...
#     # next_point = current_point + dt**2/2.*np.array( [vx, vy] )
#     next_point = current_point + dt*np.array( [vx, vy] )
#     return next_point