...
def map(obstacles_poses, R_obstacles, borders_width=2, nrows=500, ncols=500):
    """ Obstacles map """
...
def combined_potential(obstacles_poses, R_obstacles, goal, influence_radius=2, attractive_coef=1./700, repulsive_coef=300, nrows=500, ncols=500):
    """ Repulsive potential """
